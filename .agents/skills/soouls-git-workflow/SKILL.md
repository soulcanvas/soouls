---
name: soouls-git-workflow
description: Enforce the 3-layer Git workflow for the Soouls project. Always use this when starting a new task, submitting code, or interacting with git branches.
---

# Soouls Git Workflow Skill

You are working on the Soouls codebase, which enforces a strict 3-tier Git branching strategy.

---
name: soouls-architecture
description: Technical Architecture and Design guidelines for the Soouls project.
---

# 🚀 Soouls Technical Architecture
...
- **API:** tRPC v11 (type-safe contract in `@soouls/api`)

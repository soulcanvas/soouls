        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative h-[500px] rounded-[56px] overflow-hidden group">
            ...
            <div className="absolute bottom-12 left-12 z-20">
               <span className="font-urbanist text-xs font-bold text-[#D6C2A3] tracking-[0.3em] uppercase mb-4 block">Minimal Setup</span>
               <h3 className="font-playfair text-3xl font-bold text-white italic">Archive in a glance.</h3>
            </div>
          </div>
          ...
          <div className="space-y-16">
            <div className="max-w-md">
               <h4 className="font-urbanist text-[11px] font-bold text-[#E07A5F] tracking-[0.3em] uppercase mb-6">Minimal System Requirements</h4>
            ...
            <div className="max-w-md">
               <h4 className="font-urbanist text-[11px] font-bold text-[#E07A5F] tracking-[0.3em] uppercase mb-6">Sync Note</h4>
               ...
               <p className="font-urbanist text-base text-[#888888] leading-relaxed">
                  Our local-first architecture ensures that your data is always accessible, 
                  even without an internet connection. Real-time sync works in the background 
                  to keep all your devices in harmony.
               </p>
            </div>

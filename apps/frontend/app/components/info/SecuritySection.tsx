...
import { HiLockClosed, HiKey, HiShieldCheck } from 'react-icons/hi2';
    ...
    <section id="security" className="relative w-full py-32 bg-[#161616] overflow-hidden">
      <div className="relative z-10 max-w-[1240px] mx-auto px-6">
        ...
        <div className="max-w-[700px] mb-24">
          <p className="font-urbanist text-xs font-bold text-[#E07A5F] tracking-[0.4em] uppercase mb-4">Security first</p>
          ...
          <p className="font-urbanist text-xl text-[#888888] leading-relaxed">
            We build with the assumption that your private thoughts shouldn't even be readable by us. 
            Security isn't a feature; it's the foundation of tranquility.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {[
            ...
            <div key={item.title} className="p-10 rounded-[40px] bg-white/[0.02] border border-white/[0.05] hover:border-[#E07A5F]/20 transition-all flex flex-col gap-6">
        ...
        <div className="relative p-20 rounded-[64px] bg-[#1D2122] border border-white/[0.05] flex flex-col items-center text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h3 className="font-playfair text-4xl md:text-5xl font-bold text-[#EFEBDD] mb-8">We don't monetize your mind</h3>
            <p className="font-urbanist text-[#A8A8A8] text-lg leading-relaxed mb-12">
              You are our customer, not our product. We will never sell your data, use it for advertising, 
              or feed it into large language models without your explicit consent for personalized features.
            </p>
            
            <div className="pt-12 border-t border-white/5">
               <p className="font-urbanist text-xs font-bold text-[#888888] tracking-[0.3em] uppercase mb-6">Found a vulnerability?</p>
               <a 

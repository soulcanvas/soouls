  ...
  const releases = [
    {
      ...
      changes: ['Improved typography rendering', 'New meditation background sounds', 'Enhanced local-first sync stability'],
    },
    {
      version: 'v0.8.0',
      date: 'MARCH 2026',
      title: 'Public Alpha Launch',
      changes: ['Initial release to waitlist', 'Core canvas functionality', 'End-to-end encryption layer'],
    },
  ];
            ...
            <div key={release.version} className="relative pl-12 border-l border-white/10 group">
              ...
              <div className="p-10 rounded-[40px] bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-all">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                  <div>
                    <span className="font-urbanist text-[11px] font-bold text-[#E07A5F] tracking-[0.3em] uppercase mb-2 block">{release.date}</span>
                    <h3 className="font-urbanist text-3xl font-bold text-[#EFEBDD]">{release.title}</h3>
                  </div>

...
export function DailyTimeGrid({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {/* Grid Body */}
      <div ref={scrollContainerRef} className="flex-1 overflow-y-auto relative min-h-[400px] border border-white/5 rounded-2xl bg-black/20 backdrop-blur-sm">
                    ...
                    <div className="text-xs opacity-70 mt-1 flex items-center gap-2">
                      {isAllDay ? (
                        ...
                        <>
                          ...
                          <span>-</span>
                          <span>{endDate.toLocaleTimeString([], {hour: 'numeric', minute:'2-digit'})}</span>
                        </>
                      )}
                    </div>
                  </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      {entry.createdAt.toLocaleTimeString([], {hour: 'numeric', minute:'2-digit'})}
                    </div>
                  </button>
                );
              })}

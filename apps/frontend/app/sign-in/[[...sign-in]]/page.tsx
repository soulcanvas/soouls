        ...
        <div className="z-10 w-full max-w-[420px] bg-[#1A1A1A]/80 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 md:p-10 shadow-2xl relative">
          ...
          <div className="text-center mb-10 pt-4">
            ...
            <p className="text-sm text-slate-400">
              We sent a code to{" "}
              <span className="text-orange-300">{phoneNumber}</span>
            </p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#111111] flex flex-col items-center justify-center font-sans text-slate-200 relative overflow-hidden">
      ...
      <div className="z-10 mb-8 text-center">
        <h1 className="font-serif text-3xl italic text-orange-200/90 tracking-wide">
          Soouls
        </h1>
      </div>
      ...
      <div className="z-10 w-full max-w-[420px] bg-[#1A1A1A]/80 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 md:p-10 shadow-2xl relative">
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-xs px-2">
              <label className="flex items-center space-x-2 cursor-pointer group">
                <input type="checkbox" className="rounded bg-[#222222] border-transparent text-orange-400 focus:ring-0 focus:ring-offset-0 w-4 h-4 cursor-pointer" />
                <span className="text-slate-400 group-hover:text-slate-300 transition-colors">Keep session active</span>
              </label>
              <Link href="/forgot-password" className="text-orange-400/80 hover:text-orange-300 transition-colors">
                Forgot password?
              </Link>
            </div>
        ...
        <div className="mt-8 text-center text-xs text-slate-500">
          New here?{" "}
          <Link href="/sign-up" className="text-orange-300/80 hover:text-orange-200 transition-colors">
            Create an Account
          </Link>
        </div>
      </div>
